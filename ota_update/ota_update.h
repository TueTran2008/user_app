...
#define OTA_UPDATE_FLAG_ROLLBACK_FIRMWARE               0x15790864
#define OTA_UPDATE_FLAG_INVALID_BINARY_FIRMWARE         0x57934268
...
/*!
 * @brief		Roolback OTA firmware
 */
void ota_update_rollback_firmware(void);

/*!
 * @brief		Set invalid binary firmware
 */
