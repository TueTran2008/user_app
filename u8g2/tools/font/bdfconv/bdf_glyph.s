...
.LFB11:
	...
	leaq	__PRETTY_FUNCTION__.3207(%rip), %rcx
	movl	$100, %edx
	leaq	.LC0(%rip), %rsi
	leaq	.LC1(%rip), %rdi
...
.L39:
	...
	movq	8(%rax), %rdx
	.loc 1 158 24
	movq	last_encoding.3232(%rip), %rax
	.loc 1 158 8
	cmpq	%rax, %rdx
	je	.L41
	.loc 1 160 17
	...
	movq	8(%rax), %rax
	.loc 1 165 21
	movq	%rax, last_encoding.3232(%rip)
	jmp	.L40
.L41:
	.loc 1 167 25
	movl	-12(%rbp), %eax
	movslq	%eax, %rdx
	movq	biggest_x.3233(%rip), %rax
	.loc 1 167 13
	cmpq	%rax, %rdx
	jle	.L40
	.loc 1 169 17
...
.L40:
	...
	leaq	__PRETTY_FUNCTION__.3234(%rip), %rcx
	movl	$177, %edx
	leaq	.LC0(%rip), %rsi
	leaq	.LC6(%rip), %rdi
	call	__assert_fail@PLT
...
.LFE24:
	...
	.size	__PRETTY_FUNCTION__.3207, 17
__PRETTY_FUNCTION__.3207:
	.string	"bg_AddTargetBits"
	.data
	.align 8
	.type	last_encoding.3232, @object
	.size	last_encoding.3232, 8
last_encoding.3232:
	.quad	4294967295
	.align 8
	.type	biggest_x.3233, @object
	.size	biggest_x.3233, 8
biggest_x.3233:
	.quad	-1
	.section	.rodata
	.align 16
	.type	__PRETTY_FUNCTION__.3234, @object
	.size	__PRETTY_FUNCTION__.3234, 18
__PRETTY_FUNCTION__.3234:
