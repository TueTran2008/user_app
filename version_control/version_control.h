...
#define OTA_UPDATE_DEFAULT_HEADER_DATA_FIRMWARE  "G2V4"
#define VERSION_CONTROL_DEVICE			OTA_UPDATE_DEFAULT_HEADER_DATA_FIRMWARE
#define VERSION_CONTROL_FW				"0.1.0"
#define VERSION_CONTROL_HW				"0.0.4"
